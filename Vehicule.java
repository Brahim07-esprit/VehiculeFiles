...
public class Vehicule {
    ...
    public Vehicule(String immatriculation, String type_du_vehicule, String marque, int cin_conducteur, int etat, int kilometrage, BufferedImage ImageV) {
    ...
    public BufferedImage getImageV() {
        return ImageV;
    }

    public void setImageV(BufferedImage ImageV) {
        this.ImageV = ImageV;
    }
